...
public class FirstPersonController : MonoBehaviour
{
    ...
    public bool enableGlobalClickTrigger = false;
    public string animationClickTrigger = "clik";
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.enableGlobalClickTrigger = EditorGUILayout.ToggleLeft(new GUIContent("Enable Click Trigger", "Activates the specified Global Event Trigger on Left Mouse Click."), fpc.enableGlobalClickTrigger);
